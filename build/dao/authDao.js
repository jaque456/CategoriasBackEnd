...
var AuthDAO = /** @class */ (function () {
    function AuthDAO() {
    }
    AuthDAO.prototype.getUser = function (usuario) {
    ...
    AuthDAO.prototype.getUserById = function (cveUsuario) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.then(function (connection) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, connection.query('SELECT * FROM usuario WHERE cveUsuario = ?', [cveUsuario])];
                                    case 1: return [2 /*return*/, _a.sent()];
                                }
                            });
                        }); })];
