...
exports.controllersCategorias = void 0;
var categoriasDao_1 = require("../dao/categoriasDao");
var MascotasController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, categoriasDao_1.categoriaDao.lista()];
                    case 1:
                        result = _a.sent();
                        res.json(result);
                        return [3 /*break*/, 3];
    ...
    MascotasController.prototype.insert = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, nombreCategoria, descripcion, cveRegistro, tipo, categoria, result, ex_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, nombreCategoria = _a.nombreCategoria, descripcion = _a.descripcion, cveRegistro = _a.cveRegistro, tipo = _a.tipo;
                        if (nombreCategoria == null || descripcion == null || cveRegistro == null || tipo == null) {
                            return [2 /*return*/, res.status(400).json({ meesage: "Los datos son requeridos" })];
                        }
                        categoria = {
                        ...
                        return [4 /*yield*/, categoriasDao_1.categoriaDao.insert(categoria)];
                    case 1:
                        result = _b.sent();
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (categoria.cveCategoria == null) {
                            return [2 /*return*/, res.status(400).json({ meesage: "No se puede actualizar" })];
                        }
                        return [4 /*yield*/, categoriasDao_1.categoriaDao.update(categoria)];
                    case 1:
                        result = _a.sent();
                        if (result.affectedRows > 0) {
    ...
    MascotasController.prototype.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var cveCategoria, result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
...
exports.controllersCategorias = new MascotasController();
